...
namespace Neptuno2023.Windows
{
    public partial class frmCategorias : Form
    {
        ...
        private void MostrarDatosEnGrilla()
        {
            ...
            {
                DataGridViewRow r = ConstruirFila();//dgvRow crea una fila en blanco y va a tomar la forma que instancio en el construirfila
                ...
                SetearFila(r, categoria);//aca le digo a la fila r, le voy a pasar los datos dde la categoria
                //ahora ya tengo la fila con sus celdas y cada celda tiene un valor asociado
                AgregarFila(r);//ahora tengo que agregar esa fila nueva al DGV
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                try
                {
                    ...
                    DataGridViewRow r = ConstruirFila();//construyo la fila del pais nuevo para cargarlo a la grilla      ||  TODO ESTO
                    SetearFila(r, categoria);//paso la fila y que dato voy agregar                                        ||  SI NO LO
                    AgregarFila(r);//agrego la fila a la grilla                                                           ||  PONGO CUANDO
                    ...
                    //DEJE ACAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
